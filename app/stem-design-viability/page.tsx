...
export default function STEMDesignViability() {
  return (
        ...
        >
          ...
          >
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
                This document applies STEM (Science, Technology, Engineering, and Mathematics) principles and practices to the Advanced Multi-Sensing Mobility System and considers the viability of the design. It connects the project to core engineering and scientific methods and evaluates how the solution holds up under real-world constraints and criteria.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <motion.a
                href="https://docs.google.com/document/d/1jji2BfSywQFdpyOn_dFVmvy8EST1tJ1Z3RMIJscSTbs/edit?tab=t.0"
                target="_blank"
            ...
            <div className="aspect-video w-full rounded-lg overflow-hidden border border-white/10">
              <iframe
                src="https://docs.google.com/document/d/1jji2BfSywQFdpyOn_dFVmvy8EST1tJ1Z3RMIJscSTbs/preview"
                className="w-full h-full"
                title="Application of STEM Principles and Practices and Consideration of Design Viability"
                allow="fullscreen"
              />
            </div>
          </motion.div>
